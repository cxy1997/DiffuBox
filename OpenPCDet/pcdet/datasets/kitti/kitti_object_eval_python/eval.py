...
def clean_data(gt_anno, dt_anno, current_class, difficulty):
    ...
    MAX_OCCLUSION = [0, 1, 2, 2]
    MAX_TRUNCATION = [0.15, 0.3, 0.5, 0.5]
    DIST_LB = [0,  30, 50, 0]
    DIST_UB = [30, 50, 80, 80]
    ...
    for i in range(num_gt):
        ...
        if ((gt_anno["occluded"][i] > MAX_OCCLUSION[difficulty])
                ...
                or not (DIST_LB[difficulty] < gt_anno["location"][i, 2] < DIST_UB[difficulty])
        ):
    ...
    for i in range(num_dt):
        ...
        if not (DIST_LB[difficulty] < dt_anno["location"][i, 2] < DIST_UB[difficulty]):
            ignored_dt.append(1)
        elif valid_class == 1:
            ignored_dt.append(0)
        else:
...
def get_official_eval_result(gt_annos, dt_annos, current_classes, PR_detail_dict=None):
    ...
    overlap_0_5 = np.array([[0.5, 0.5, 0.5, 0.7, 0.5, 0.5],
                            ...
                            [0.5, 0.5, 0.5, 0.5, 0.25, 0.5],
                            [0.5, 0.5, 0.5, 0.5, 0.25, 0.5]])
    overlap_0_25 = np.array([[0.25, 0.25, 0.25, 0.7, 0.5, 0.5],
                            [0.25, 0.25, 0.25, 0.5, 0.25, 0.5],
                            [0.25, 0.25, 0.25, 0.5, 0.25, 0.5],
                            [0.25, 0.25, 0.25, 0.5, 0.25, 0.5]])
    min_overlaps = np.stack([overlap_0_7, overlap_0_5, overlap_0_25], axis=0)  # [3, 4, 5]
    class_to_name = {
        0: 'Car',
        1: 'Pedestrian',
        2: 'Cyclist',
    ...
    for j, curcls in enumerate(current_classes):
        ...
        for i in range(min_overlaps.shape[0]):
            ...
            if i == 0:
                ...
                ret_dict['%s_3d/0-30m_R40' % class_to_name[curcls]] = mAP3d_R40[j, 0, 0]
                ret_dict['%s_3d/30-50m_R40' % class_to_name[curcls]] = mAP3d_R40[j, 1, 0]
                ret_dict['%s_3d/50-80m_R40' % class_to_name[curcls]] = mAP3d_R40[j, 2, 0]
                ret_dict['%s_3d/0-80m_R40' % class_to_name[curcls]] = mAP3d_R40[j, 3, 0]
                ret_dict['%s_bev/0-30m_R40' % class_to_name[curcls]] = mAPbev_R40[j, 0, 0]
                ret_dict['%s_bev/30-50m_R40' % class_to_name[curcls]] = mAPbev_R40[j, 1, 0]
                ret_dict['%s_bev/50-80m_R40' % class_to_name[curcls]] = mAPbev_R40[j, 2, 0]
                ret_dict['%s_bev/0-80m_R40' % class_to_name[curcls]] = mAPbev_R40[j, 3, 0]
                ...
                ret_dict['%s_3d/0-30m_R40_0.5' % class_to_name[curcls]] = mAP3d_R40[j, 0, 1]
                ret_dict['%s_3d/30-50m_R40_0.5' % class_to_name[curcls]] = mAP3d_R40[j, 1, 1]
                ret_dict['%s_3d/50-80m_R40_0.5' % class_to_name[curcls]] = mAP3d_R40[j, 2, 1]
                ret_dict['%s_3d/0-80m_R40_0.5' % class_to_name[curcls]] = mAP3d_R40[j, 3, 1]
                ret_dict['%s_bev/0-30m_R40_0.5' % class_to_name[curcls]] = mAPbev_R40[j, 0, 1]
                ret_dict['%s_bev/30-50m_R40_0.5' % class_to_name[curcls]] = mAPbev_R40[j, 1, 1]
                ret_dict['%s_bev/50-80m_R40_0.5' % class_to_name[curcls]] = mAPbev_R40[j, 2, 1]
                ret_dict['%s_bev/0-80m_R40_0.5' % class_to_name[curcls]] = mAPbev_R40[j, 3, 1]

                ret_dict['%s_3d/0-30m_R40_0.25' % class_to_name[curcls]] = mAP3d_R40[j, 0, 2]
                ret_dict['%s_3d/30-50m_R40_0.25' % class_to_name[curcls]] = mAP3d_R40[j, 1, 2]
                ret_dict['%s_3d/50-80m_R40_0.25' % class_to_name[curcls]] = mAP3d_R40[j, 2, 2]
                ret_dict['%s_3d/0-80m_R40_0.25' % class_to_name[curcls]] = mAP3d_R40[j, 3, 2]
                ret_dict['%s_bev/0-30m_R40_0.25' % class_to_name[curcls]] = mAPbev_R40[j, 0, 2]
                ret_dict['%s_bev/30-50m_R40_0.25' % class_to_name[curcls]] = mAPbev_R40[j, 1, 2]
                ret_dict['%s_bev/50-80m_R40_0.25' % class_to_name[curcls]] = mAPbev_R40[j, 2, 2]
                ret_dict['%s_bev/0-80m_R40_0.25' % class_to_name[curcls]] = mAPbev_R40[j, 3, 2]
